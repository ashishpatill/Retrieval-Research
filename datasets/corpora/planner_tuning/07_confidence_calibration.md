...
The planner sweep should compare score_base, score_rerank_soft, route_vote_mid, route_vote_rerank_mid, and route_vote_rerank_strong. The current default is score_rerank_soft because it improves MRR without inflating confidence on ambiguous questions.
